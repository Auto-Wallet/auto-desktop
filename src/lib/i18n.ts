...
const DICT: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "settings.retryAutoUpdate": "Retry auto update",
    ...
    "settings.updateAutoUnavailable":
      "Auto update is unavailable: {error}. You can retry or download manually.",
    "settings.updateAutoFailed":
      "Auto update failed: {error}. You can retry or download manually.",
    ...
    "settings.searchNetworks": "Search networks",
    "settings.noNetworkMatches": "No matching networks.",
    ...
    "wallet.searchTokenHoldings": "Search tokens or networks",
    "wallet.noTokenMatches": "No matching tokens.",
    "wallet.showZeroTokens": "Show 0 balance tokens ({count})",
    "wallet.hideZeroTokens": "Hide 0 balance tokens",
    ...
    "wallet.send": "Send",
    "wallet.swap": "Swap",
    "wallet.swapBridge": "Swap / Cross-chain",
    "wallet.youPay": "You pay",
    "wallet.youReceive": "You receive",
    "wallet.loadingTokens": "Loading tokens…",
    "wallet.waitingForQuote": "Waiting for quote",
    "wallet.enterAmount": "Enter amount",
    "wallet.quoteTimeout": "Quote timed out. Try again in a moment.",
    "wallet.okxBestRoute": "Best OKX route",
    "wallet.okxTracking": "Tracking OKX swap…",
    "wallet.networkFee": "Network fee",
    "wallet.noOkxAssets": "No OKX-supported balance available to swap.",
    "wallet.from": "From",
    "wallet.to": "To",
    "wallet.selectToken": "Select token",
    "wallet.selectFromAsset": "Select source asset",
    "wallet.selectToAsset": "Select destination asset",
    "wallet.searchChains": "Search chains",
    "wallet.searchTokens": "Search tokens or paste address",
    "wallet.noTokensFound": "No tokens found.",
    "wallet.fetchingQuotes": "Fetching quotes…",
    "wallet.minReceived": "Min received",
    "wallet.slippage": "Slippage",
    "wallet.customSlippage": "Custom",
    "wallet.slippageRange": "Use 0.01% to 50%. Lower slippage reduces sandwich risk but may fail more often.",
    "wallet.invalidSlippage": "Invalid slippage",
    "wallet.route": "Route",
    ...
    "wallet.approving": "Approving…",
    "wallet.approveToken": "Approve {symbol}",
    "wallet.submitting": "Submitting…",
    "wallet.swapVia": "Swap via {provider}",
    "wallet.swapComplete": "Swap complete",
    "wallet.swapFailed": "Swap failed",
    "wallet.swapTracking": "Tracking via {provider}…",
    ...
    "wallet.activitySwapVia": "Swapped via {provider}",
    ...
    "wallet.activityReplaced": "Replaced",
    "wallet.activityNoValue": "No value",
    "wallet.speedUp": "Speed up",
    "wallet.speedUpTx": "Speed up transaction",
    "wallet.revokeTx": "Revoke transaction",
    "wallet.originalTx": "Original transaction",
    "wallet.maxFeePerGas": "Max fee per gas",
    "wallet.priorityFee": "Priority fee",
    "wallet.invalidGas": "Enter valid gas fees.",
    "wallet.priorityTooHigh": "Priority fee cannot exceed max fee.",
    "wallet.speedUpHint":
      "Broadcasts the same transaction with the same nonce and your higher gas fees.",
    "wallet.revokeHint":
      "Broadcasts a 0-value transaction to yourself with the same nonce to cancel the pending transaction.",
    ...
    "safe.group": "Safe wallets",
    "safe.import": "Import Safe",
    "safe.address": "Safe address",
    "safe.name": "Safe name",
    "safe.namePlaceholder": "e.g. Treasury",
    "safe.serviceUrl": "Transaction Service URL",
    "safe.serviceHint":
      "AutoDesktop uses Safe's off-chain service to load pending transactions and submit your confirmation. Custom networks can use a self-hosted service.",
    "safe.invalidAddress": "Enter a valid Safe contract address.",
    "safe.alreadyAdded": "This address is already in your account list.",
    "safe.noLocalOwner":
      "None of this Safe's current owners are available in your local wallets.",
    "safe.inspectFirst": "Verify the Safe contract before importing it.",
    "safe.selectOwner": "Select a local owner address.",
    "safe.serviceRequired": "Enter a Safe Transaction Service URL.",
    "safe.imported": "Safe imported",
    "safe.inspect": "Verify Safe",
    "safe.thresholdLabel": "Threshold",
    "safe.threshold": "{threshold} of {owners} signatures",
    "safe.nonce": "Current nonce",
    "safe.localOwner": "Local owner",
    "safe.removeConfirm": "Remove this imported Safe?",
    "safe.queue": "Pending Safe transactions",
    "safe.openWallet": "Open Safe",
    "safe.confirmed": "Safe confirmation submitted",
    "safe.loading": "Loading the Safe queue…",
    "safe.noPending": "No pending Safe transactions.",
    "safe.contractCall": "Contract call",
    "safe.transfer": "Transfer",
    "safe.confirmations": "{current}/{required} confirmations",
    "safe.signed": "Signed",
    "safe.signing": "Confirm in window…",
    "safe.sign": "Sign",
    "safe.manualSigning":
    ...
    "settings.revealPrivateKeyHint": "Show this wallet's private key. Never share it.",
    "settings.exportPhraseTitle": "Export recovery phrase",
    "settings.exportPrivateKeyTitle": "Export private key",
    "settings.exportSecretWarning":
      "Anyone with this secret can control this wallet. Make sure no one can see your screen, and never paste it into a website.",
    "settings.revealSecret": "Reveal secret",
    "settings.secretCopied": "Secret copied",
    ...
    "approval.confirmSafe": "Confirm Safe transaction",
    ...
    "approval.approveTitle": "ERC-20 Approve",
    "approval.approveAmount": "Approve amount",
    "approval.approveAmountInvalid": "Enter a valid approve amount.",
    "approval.approveTokenLoading": "Loading token…",
    "approval.approveTokenLoadFailed": "Unable to load token balance.",
    "approval.editable": "Editable",
    "approval.useBalance": "Use balance",
    ...
    "approval.typedDomain": "App",
    "approval.typedVersion": "Version",
    "approval.typedChainId": "Chain ID",
    "approval.typedContract": "Verifying contract",
    "approval.typedType": "Data type",
    "approval.permitWarnTitle": "This signature can spend your tokens",
    "approval.permitWarnBody":
      "Approving grants the spender an off-chain token allowance — no on-chain transaction needed. Verify every field below.",
    "approval.permitAmountUnlimited": "Unlimited — entire balance at risk",
    "approval.permitNeverExpires": "Never expires",
    "approval.allowance": "Allowance",
    "approval.deadline": "Deadline",
    "approval.rawAmount": "{n} (raw token units)",
    "approval.transferTitle": "ERC-20 Transfer",
    "approval.transferRecipient": "Recipient",
    "approval.transferOwner": "From (owner)",
  ...
  zh: {
    ...
    "settings.retryAutoUpdate": "重试自动更新",
    ...
    "settings.updateAutoUnavailable":
      "自动更新不可用：{error}。你可以重试或手动下载。",
    "settings.updateAutoFailed":
      "自动更新失败：{error}。你可以重试或手动下载。",
    "settings.updateFailed": "检查更新失败：{error}",
    "settings.unknownError": "未知错误",
    "settings.upToDate": "已是最新版本。",
    "settings.addNetwork": "添加网络",
    "settings.searchNetworks": "搜索网络",
    "settings.noNetworkMatches": "没有匹配的网络。",
    ...
    "wallet.searchTokenHoldings": "搜索代币或网络",
    "wallet.noTokenMatches": "没有匹配的代币。",
    "wallet.showZeroTokens": "显示 0 余额代币（{count}）",
    "wallet.hideZeroTokens": "隐藏 0 余额代币",
    ...
    "wallet.send": "发送",
    "wallet.swap": "兑换",
    "wallet.swapBridge": "兑换 / 跨链",
    "wallet.youPay": "支付",
    "wallet.youReceive": "收到",
    "wallet.loadingTokens": "加载代币中…",
    "wallet.waitingForQuote": "等待报价",
    "wallet.enterAmount": "输入金额",
    "wallet.quoteTimeout": "报价超时，请稍后重试。",
    "wallet.okxBestRoute": "OKX 最优路径",
    "wallet.okxTracking": "正在跟踪 OKX 兑换…",
    "wallet.networkFee": "网络费用",
    "wallet.noOkxAssets": "暂无 OKX 支持且有余额的可兑换资产。",
    "wallet.from": "从",
    "wallet.to": "到",
    "wallet.selectToken": "选择代币",
    "wallet.selectFromAsset": "选择支付资产",
    "wallet.selectToAsset": "选择目标资产",
    "wallet.searchChains": "搜索链",
    "wallet.searchTokens": "搜索代币或粘贴地址",
    "wallet.noTokensFound": "没有找到匹配的代币。",
    "wallet.fetchingQuotes": "正在报价…",
    "wallet.minReceived": "最少收到",
    "wallet.slippage": "滑点",
    "wallet.customSlippage": "自定义",
    "wallet.slippageRange": "请输入 0.01% 到 50%。较低滑点可降低三明治攻击风险，但更容易交易失败。",
    "wallet.invalidSlippage": "滑点无效",
    "wallet.route": "路径",
    "wallet.priceImpact": "价格影响",
    "wallet.feeDetails": "手续费明细",
    "wallet.feeUnavailable": "服务商未提供明细",
    "wallet.feeNetwork": "网络费用",
    "wallet.feeMessage": "跨链消息费用",
    "wallet.feeBridge": "跨桥费用",
    "wallet.feeProtocol": "协议费用",
    "wallet.feeProvider": "服务商费用",
    "wallet.feeDex": "DEX 费用",
    "wallet.feeRelay": "Relay 费用",
    "wallet.feeApp": "应用费用",
    "wallet.approving": "授权中…",
    "wallet.approveToken": "授权 {symbol}",
    "wallet.submitting": "提交中…",
    "wallet.swapVia": "通过 {provider} 兑换",
    "wallet.swapComplete": "兑换完成",
    "wallet.swapFailed": "兑换失败",
    "wallet.swapTracking": "正在通过 {provider} 跟踪…",
    "wallet.received": "已收到",
    "wallet.buy": "购买",
    "wallet.wallets": "钱包",
    ...
    "wallet.activitySwapVia": "使用 {provider} 兑换",
    "wallet.activityToken": "代币",
    "wallet.activitySubmitted": "已提交",
    "wallet.activityConfirmed": "已确认",
    "wallet.activityFailed": "失败",
    "wallet.activityReplaced": "已替换",
    "wallet.activityNoValue": "无转账金额",
    "wallet.speedUp": "加速",
    "wallet.speedUpTx": "加速交易",
    "wallet.revokeTx": "取消交易",
    "wallet.originalTx": "原交易",
    "wallet.maxFeePerGas": "最高 Gas 单价",
    "wallet.priorityFee": "优先费",
    "wallet.invalidGas": "请输入有效的 Gas 费用。",
    "wallet.priorityTooHigh": "优先费不能高于最高 Gas 单价。",
    "wallet.speedUpHint": "使用相同 nonce 和更高 Gas 费用重新广播同一笔交易。",
    "wallet.revokeHint": "使用相同 nonce 给自己发送 0 金额交易，以取消原 pending 交易。",
    ...
    "safe.name": "Safe 名称",
    "safe.namePlaceholder": "例如：资金库",
    "safe.serviceUrl": "交易服务 URL",
    "safe.serviceHint":
      "AutoDesktop 通过 Safe 的链下服务读取待签交易并提交签名；自定义网络可填写自建服务。",
    "safe.invalidAddress": "请输入有效的 Safe 合约地址。",
    "safe.alreadyAdded": "该地址已存在于账户列表中。",
    "safe.noLocalOwner": "本地钱包中没有该 Safe 当前的 Owner 地址。",
    "safe.inspectFirst": "请先验证 Safe 合约。",
    "safe.selectOwner": "请选择本地 Owner 地址。",
    "safe.serviceRequired": "请输入 Safe Transaction Service URL。",
    "safe.imported": "Safe 已导入",
    "safe.inspect": "验证 Safe",
    "safe.thresholdLabel": "签名门槛",
    "safe.threshold": "{owners} 个 Owner 中需 {threshold} 个签名",
    "safe.nonce": "当前 Nonce",
    "safe.localOwner": "本地 Owner",
    "safe.removeConfirm": "移除这个已导入的 Safe？",
    "safe.queue": "Safe 待签交易",
    "safe.openWallet": "打开 Safe",
    "safe.confirmed": "Safe 签名已提交",
    "safe.loading": "正在加载 Safe 队列…",
    "safe.noPending": "没有待签的 Safe 交易。",
    "safe.contractCall": "合约调用",
    "safe.transfer": "转账",
    "safe.confirmations": "已签 {current}/{required}",
    "safe.signed": "已签名",
    "safe.signing": "请在确认窗口操作…",
    "safe.sign": "签名",
    "safe.manualSigning":
    ...
    "settings.revealPrivateKey": "显示私钥",
    "settings.revealPrivateKeyHint": "显示这个钱包的私钥。切勿分享。",
    "settings.exportPhraseTitle": "导出助记词",
    "settings.exportPrivateKeyTitle": "导出私钥",
    "settings.exportSecretWarning":
      "任何拿到这段密钥的人都能控制这个钱包。请确认没有人能看到你的屏幕，也不要把它粘贴到任何网站。",
    "settings.revealSecret": "显示密钥",
    "settings.secretCopied": "密钥已复制",
    ...
    "approval.confirmSafe": "确认 Safe 交易",
    ...
    "approval.balance": "余额",
    "approval.token": "代币",
    "approval.spender": "授权对象",
    "approval.approveTitle": "ERC-20 授权",
    "approval.approveAmount": "授权数量",
    "approval.approveAmountInvalid": "请输入有效的授权数量。",
    "approval.approveTokenLoading": "正在加载代币…",
    "approval.approveTokenLoadFailed": "无法加载代币余额。",
    "approval.editable": "可编辑",
    "approval.useBalance": "使用余额",
    ...
    "approval.typedDomain": "应用",
    "approval.typedVersion": "版本",
    "approval.typedChainId": "链 ID",
    "approval.typedContract": "验证合约",
    "approval.typedType": "数据类型",
    "approval.permitWarnTitle": "该签名可动用你的代币",
    "approval.permitWarnBody":
      "批准后将在链下授予对方代币支配额度（无需任何链上交易）。请逐项核对以下字段。",
    "approval.permitAmountUnlimited": "无限额度——全部余额可被转走",
    "approval.permitNeverExpires": "永不过期",
    "approval.allowance": "授权额度",
    "approval.deadline": "截止时间",
    "approval.rawAmount": "{n}（代币最小单位）",
    "approval.transferTitle": "ERC-20 转账",
    "approval.transferRecipient": "收款地址",
